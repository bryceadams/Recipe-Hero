...
<div id="message" class="updated recipe-hero-message rh-connect">
	...
	<p class="submit"><a href="http://wordpress.org/plugins/recipe-hero-labels" class="rh-update-now button-primary" target="_blank"><?php _e( 'Download', 'recipe-hero' ); ?></a> <a href="<?php echo add_query_arg( 'dismiss_rh_labels_notice', 'true', admin_url( 'admin.php?page=rh-settings' ) ); ?>" class="rh-update-now button-primary"><?php _e( 'Cool - Understood!', 'recipe-hero' ); ?></a></p>
</div>