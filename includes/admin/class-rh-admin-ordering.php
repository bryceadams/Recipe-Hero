<?php
/* Based off Simple Page Ordering by @10up (http://10up.com/) - http://10up.com/plugins/simple-page-ordering-wordpress/ */

if ( ! class_exists( 'RH_Recipe_Ordering' ) ) :

class RH_Recipe_Ordering {
