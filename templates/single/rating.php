...
if ( get_option( 'recipe_hero_enable_review_rating' ) === 'no' ) {
	...
	if ( comments_open() ) : ?>
		<span class="dashicons dashicons-testimonial"></span> <a href="#reviews" rel="nofollow"><?php printf( _n( '%s Review', '%s Reviews', $count, 'recipe-hero' ), '<span itemprop="ratingCount" class="count">' . $count . '</span>' ); ?></a>
	<?php endif;
