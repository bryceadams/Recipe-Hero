...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
	...
	public function credits_screen() {
		...
		<div class="wrap about-wrap">
			...
			<p class="about-description"><?php _e( 'Recipe Hero is developed by <a href="http://bryceadams.com/">Bryce Adams</a> and maintained by a worldwide team of passionate individuals, backed by an awesome developer community. Want to see your name? <a href="https://github.com/bryceadams/Recipe-Hero/">Contribute to Recipe Hero</a>.', 'recipe-hero' ); ?></p>
